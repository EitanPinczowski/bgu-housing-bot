...
- available_rooms_count = מספר החדרים הפנויים כרגע להשכרה.
...
- is_apartment_ad = false אם זו אינה מודעת השכרת דירה (חיפוש שותף לדירה קיימת נחשב true;
  מכירת רהיטים, שירותים, או פוסט לא קשור = false).
החזר JSON בלבד."""
