...
- street_address_or_neighborhood = הרחוב, השכונה או האזור שבו נמצאת הדירה, כפי שמופיע
  ...
  חשוב: אם מופיעים גם רחוב ספציפי (עם או בלי מספר בית, למשל "רינגלבלום 5") וגם שם שכונה/אזור
  ("שכונה ג'"), החזר את הרחוב הספציפי — הכי מדויק — ולא את השכונה. השתמש בשם שכונה/אזור
  בלבד רק כאשר אין במודעה רחוב ספציפי.
